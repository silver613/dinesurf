    ...
    <div class="max-w-xl shadow-0 bg-white">
      ...
      <div class="auth-card-body text-left">
        <form
          ...
          v-if="!regSuccess"
        >
          <h3 class="mb-3">Update DineList</h3>
  ...
  export default {
    ...
    data() {
      return {
        form: this.$inertia.form({
          name: this.list?.name,
          isPrivate: this.list?.isPrivate === 1 ? true : false,
        }),
        regSuccess: false,
        responseSpin: false,
    ...
    methods: {
      ...
      submit() {
        ...
        this.responseSuccess = null;
        this.responseFail = null;
        this.responseMessage = "Updating list...";
          
        console.log("this.form:", this.form);
        console.log("this.form.isprivate:", this.form.isprivate  === 'true')
        var formData = new FormData();
              ...
              axios
            .post(route("edit.dinelist"), formData,
            {
                  headers: {
          ...
          .then(({ data }) => {
            ...
            if (result.success) {
              ...
              this.responseSuccess = null;
              this.responseFail = null;
             this.$inertia.visit(route('view.dinelist', {slug: list?.slug}));
    ...
    mounted() {
      console.log("this.list?.isPrivate:", this.list?.isPrivate)
    },
  };
  </script>

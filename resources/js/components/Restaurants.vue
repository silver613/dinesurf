...
export default {
  ...
  computed: {
    ...
    fullUrl() {
      return this.seeAll + "&" + this.filters;
    },
  },
  methods: {
    ...
    geolocate() {
      ...
      if (state_id) {
        ...
        //     vm.params.lat = position.coords.latitude;
        //     vm.params.lng = position.coords.longitude;
        //   });
        // } catch (error) {
        //   console.log(error);
        // }

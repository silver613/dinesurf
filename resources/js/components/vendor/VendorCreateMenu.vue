<template>
  <div class="auth-card2 reservation-auth-card  shadow-0 bg-white">
    ...
    <div class="auth-card-body text-left">
      <form
        ...
        v-if="!regSuccess"
      >
        <h3 class="mb-3">Create a Menu</h3>
    ...
    <div class="flex flex-col w-full">
      ...
      >
        ...
        <h4 class="text-center my-3  font-inter text-xs text-[#000000] font-normal">Menu Created Successfully</h4>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      this.responseSuccess = null;
      this.responseFail = null;
      this.responseMessage = "Creating Menu...";
      ...
      var formData = new FormData();
            ...
            axios
          .post(route("vendors.create-menu"), formData,
          {
                headers: {

<template>
  <div v-if="plans" class="mt-10">
    ...
    <div class="shadow-mp-4 mt-6 pt-0 ">
       ...
       <div class="flex  mt-3 mb-3 justify-center items-center w-full  ">

            <div class="form-check mr-5"  v-for="(duration, index)  in this.durations " :key="index">
                      ...
                      <input
                        class="
                          ...
                          radio
                        "
                         :checked=" durationSelected.id == duration.id"
                         :model="durationSelected[index]"
    ...
    <div class="flex flex-col md:flex-row flex-wrap justify-around md:mt-8">
      ...
      <div
        ...
        "
      >
        <template v-if="durationSelected">
          <div>
                 ...
                 <div class="ml-4 mr-4">
                  ...
                  <div class="flex  flex-col">
                     ...
                     <span class="text-gray-400 text-sm">  {{
                        numberWithCommas(
                          getCurrentPlan(item.id).price,
                          getCurrentPlan(item.id).currency
                        )
                       }}/ {{ durationSelected?.duration_text }}  </span>
                  </div>
              </div>

              <div
                    class="flex items-start justify-start p-2 mt-1 pl-7"
                    v-for="(feature, index) in item.plan_features"
                    :key="index"
                  >
                    <svg
                      viewBox="0 0 20 20"
            ...
            <div class="flex justify-center w-full">
              <a
                ...
                :href="
                  payUrl({
                    plan_id: item.id,
                    plan_frequency_id: durationSelected?.id,
                  })
                "
              >
                Set As New Plan

...
use App\Nova\Metrics\TotalVendorsWithOutReservations;
...
class VendorsWithOutReservations extends Lens
{
    /**
    ...
    public static function query(LensRequest $request, $query)
    {
        return $request->withOrdering($request->withFilters(
            $query->where('approved', true)->doesnthave('reservations')
        ));
    }
    ...
    {
        return [
            new TotalVendorsWithOutReservations(),
        ];
    }
    ...
    {
        return 'vendors-vendors-with-out-reservations';
    }
}

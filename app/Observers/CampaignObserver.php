...
class CampaignObserver
{
    ...
    {
        if ($campaign->type == 'single_platform') {
            $campaign->tracker = '?campaign_id='.$campaign->id;
        }
        if ($campaign->type == 'multiple_platforms') {
            $campaign->tracker = '?campaign_id='.$campaign->id.'&source=platform_name';
        }
